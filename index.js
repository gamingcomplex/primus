...
var version = "Official Release 1.0.0";
...
bot.on("message", message => {
    ...
    if (message.content.includes("imagine") && message.author.id != bot.user.id) {
        message.channel.send("Imagine using imagine, pulling a Neal I see");
    }
    if (message.content.includes("ur mom") && message.author.id != bot.user.id) {
        message.channel.send("ur mom!!1!!!!11!1!!!!!rosted");
    }
    if (message.content.includes("no u") && message.author.id != bot.user.id) {
        message.channel.send(":UnoFlip:");
    }
    if (message.content.includes("confiemra") && message.author.id != bot.user.id) {
        message.channel.send("confiemra?@A?!AQ!?!");
    }
